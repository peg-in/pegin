...
| Document | Topic |
|----------|--------|
| [how-we-work.md](how-we-work.md) | Mottos, remote, library days, healthy mindset — [*Rework*](https://37signals.com/books/rework) |
| [collaboration-tooling.md](collaboration-tooling.md) | GitHub, Basecamp, what goes where, AI for docs |
...
5. [08-developer/environment/developer-environment.md](../08-developer/environment/developer-environment.md)  
6. [04-technical/specs/tech-stack.md](../04-technical/specs/tech-stack.md) — when coding starts  
