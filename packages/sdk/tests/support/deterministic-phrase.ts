...
/** 24-word phrase from 32 zero bytes. */
export function deterministicTestPhrase(): string {
  return entropyToMnemonic(new Uint8Array(32), wordlist)
}

/** 24-word phrase from 32 0xff bytes (wrong-key tests). */
export function alternateTestPhrase(): string {
